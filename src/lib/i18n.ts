...
export const dictionaries = {
  uz: {
    ...
    admin: {
      ...
      saving: "Saqlanmoqda...",
      colors: "Ranglar",
      colorsHint: "Vergul bilan ajrating, masalan: Qora, Ko'k, Qizil",
      sizes: "O'lchamlar",
  ...
  ru: {
    ...
    admin: {
      ...
      saving: "Сохраняем...",
      colors: "Цвета",
      colorsHint: "Через запятую, например: Чёрный, Синий, Красный",
      sizes: "Размеры",
  ...
  en: {
    ...
    admin: {
      ...
      saving: "Saving...",
      colors: "Colors",
      colorsHint: "Separate with commas, e.g. Black, Blue, Red",
      sizes: "Sizes",
